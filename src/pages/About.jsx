...
const About = () => (
  <>
    <Seo title="Florian GIURGIU — À propos" description="À propos de Florian GIURGIU, développeur web, IA, optimisation." />
  <section id="about" className="w-full py-20 px-6 md:px-12 lg:px-24 bg-gradient-to-br from-white via-blue-50 to-purple-50 text-black">
      ...
      >
  <h1 className="text-4xl md:text-5xl font-extrabold text-black mb-12 text-center">À propos de moi</h1>
      </motion.div>
